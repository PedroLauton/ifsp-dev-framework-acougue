...
<head>
    ...
    <link rel="stylesheet" href="../css/paginaErro.css">
...
<body>
    ...
    <main class="container">
        <h1 class="container__titulo">Acesso Negado</h1>
        <p class="container__texto">Você não tem permissão para acessar esta página.</p>
        <a class="container__voltar" href="../index.php">Voltar para a página inicial</a>
    </main>
    <footer class="footer">
