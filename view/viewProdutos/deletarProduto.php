...
<body>
    <?php if (!empty($produtos)): ?>
        <?php foreach($produtos as $produto): ?>
            <form action="../../model/modelProduto/deletarProdutoModel.php" method="POST">
                <input type="hidden" name="ProdutoId" value="<?php echo ($produto['ProdutoId']); ?>" >
                Nome:
                <input type="text" name="cxNome" value="<?php echo ($produto['NomeProduto']); ?>" disabled><br><br>
                Preço unitário:
                <input type="number" name="cxPreco" value="<?php echo ($produto['PrecoUnitario']); ?>" disabled><br><br>
                Porção unitária:
                <input type="number" name="cxPorcao" value="<?php echo ($produto['PorcaoUnidadeKg']); ?>" disabled><br><br>
                Categoria:
                <select id="categoria" name="cxCategoria" disabled>
                ...
                Fornecedor:
                <select id="fornecedor" name="cxFornecedor" disabled>
                ...
                Foto:
                <input type="file" name="cxFoto" disabled><br><br>
                <input type="hidden" name="fotoAtual" value="<?php echo ($produto['fotoProduto']); ?>" disabled>
